...
namespace COMP123_S2016_Lesson11A.COMP123DataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [FirstName] = @FirstName, [LastName] = @LastName, [Number] = @Number WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)));
SELECT StudentID, FirstName, LastName, Number FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::COMP123_S2016_Lesson11A.Properties.Settings.Default.COMP123ConnectionString;
        }
